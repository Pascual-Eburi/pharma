    ...
    <div class="container-xl">
        ...
        <div class="navbar-nav flex-row order-md-last">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu" id="user_avatar_info">
            ...
            <div class="search-form">
                <form action="." method="get">
                    <div class="input-icon">
                        ...
                        <input type="text" value="" class="form-control" placeholder="Buscar…" aria-label="Search in website" id="search_app">
                        <ul class="list-group elementoOculto">
