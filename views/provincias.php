...
<div class="page-body">
    <div class="container-xl">
        <div class="row column-reverse-xxs">
            ...
            <div class="col-12 col-sm-9 col-md-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <table id="tablaProvincias" class="table card-table table-vcenter text-nowrap datatable">
                        <thead>
                        <tr>
                            <th>
            ...
            <div class="col-sm-3 col-md-4" id="addUpdateProvincia">
                ...
                <div class="card-body">
                        ...
                        <div class="col-12 container-panel-aviso panel-info">
                            <div class="card bg-seconday-lt">
                                <div class="card-body">
                                    ...
                                    <p class="text-muted" id="panelAviso"> Rellena este campo para registrar una nueva provincia</p>
                                </div>
                            </div>
                        </div>
                    </div>
                  <form id="insertarRegistro">
                    ...
                    <div class="mb-3">
                        ...
                        <select type="text" class="input form-select" placeholder="Selecciona una Comunidad A." id="id_ca" name="id_ca" value="" data-required="false" data-min-length="0" data-format="numbers">
...
<script src='public/appjs/provincias.js' type="module" ></script>