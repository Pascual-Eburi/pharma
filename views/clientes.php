    ...
    <div class="row g-2 align-items-center">
        ...
        <div class="col-12 col-md-auto ms-auto d-print-none">
            <div class="btn-list" id="optionsPage">
                ...
                <span class="d-sm-inline">
                    <a href="#" id="registrarCliente" class="btn btn-white" data-bs-toggle="offcanvas" data-bs-target="#addUpdate" >
                ...
                <div class="card">
                    <div class="card-body">
                        <div id="table-default">
                            <table id="tablaClientes" class="table card-table table-vcenter text-nowrap datatable">
                                <thead>
                                <tr>
                                    <th>
                ...
                <div class="row picker-eleccion ">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-icon mb-3">
                            ...
                            <input type="text"  class="input form-control" placeholder="Telefono..." name= "telefono" id = "telefono" data-required="false" data-min-length="0" data-max-length="15" data-format="numbers">
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="input-icon">
                              ...
                              <input class="input form-control date-picker" placeholder="dd-mm-YYYY" name = "fechaNacimiento" id="fechaNacimiento" />
                        </div>
...
<script src='public/appjs/clientes.js' type="module" ></script>
